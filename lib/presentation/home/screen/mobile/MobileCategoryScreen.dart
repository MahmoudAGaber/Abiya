...
class MobileCategoryScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<MobileCategoryScreen> createState() => _CategoryScreenState();
}

class _CategoryScreenState extends ConsumerState<MobileCategoryScreen> {
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: PopupMenuButton<String>(
                            onSelected: (value) {
                              if (value == 'delete') {
                                showDeleteConfirmationDialog(context, product,index);
                              }
                            },
  ...
  void  showDeleteConfirmationDialog(BuildContext context, ProductModel product, index) {
    showDialog(
      context: context,
